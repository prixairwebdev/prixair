...
function ContactPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent(`Contact Form: ${formData.businessUnit || 'Gavi Bakery'}`);
...
Let’s Bake Something Great Together        </h1>
          <p className="text-gray-700 text-sm mb-8">
We’d love to hear from you — whether it’s feedback, questions, or custom orders, we’re just a message away.         </p>
