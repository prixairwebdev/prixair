        ...
        return (
            <div className="min-h-screen bg-[#fcfbf9] flex items-center justify-center">
                <div className="text-center">
                    <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-[#F3A35C]"></div>
    ...
    return (
        <div className="min-h-screen bg-[#fcfbf9] py-8 px-4">
            <div className="max-w-5xl mx-auto">
                <div className="mb-6">
                    <Link href="/gavi/account" className="text-[#373435] hover:text-[#F3A35C] font-medium">
                        ← Back to Account
                    </Link>
                </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div className="flex items-center justify-between">
                        ...
                        <button
                            ...
                            className="bg-[#F3A35C] text-white px-6 py-3 rounded-lg hover:bg-[#e0924e] transition-colors font-semibold shadow-md"
                        >
                            + Add Address
                        </button>
                    </div>
                        ...
                        <form onSubmit={handleAddAddress} className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-300 rounded-lg px-4 py-2 text-[#373435] focus:outline-none focus:ring-2 focus:ring-[#F3A35C]"
                                        required
                                    />
                                </div>
                                <div>
                            ...
                            <div className="flex gap-3">
                                <button
                                    type="submit"
                                    disabled={submitting}
                                    className="bg-[#F3A35C] text-white px-6 py-3 rounded-lg hover:bg-[#e0924e] transition-colors font-semibold disabled:opacity-50"
                                >
