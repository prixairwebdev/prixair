      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full md:w-[90%] lg:w-[80%]">
        ...
        >
          ...
          <div className="mt-4 md:mt-6 flex justify-center sm:justify-start">
            <button
              className="bg-gray-900 hover:bg-gray-700 text-white px-4 py-2 sm:px-5 sm:py-2.5 text-xs sm:text-sm font-medium transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-opacity-50"
