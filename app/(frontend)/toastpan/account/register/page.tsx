...
export default function RegisterPage() {
  ...
  useEffect(() => {
    const fetchStoreId = async () => {
      const store = await getStoreBySlug('toastpan');
      if (store) {
        setStoreId(store.id);
      }
    };
    ...
    <div className="min-h-screen bg-white py-12 px-4">
      <div className="max-w-md mx-auto">
        <div className="bg-white border-2 border-gray-200 rounded-lg p-8 shadow-sm">
          ...
          <p className="text-gray-600 mb-6">Join Toast Pan today</p>
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/toastpan/account/login" className="text-[#F3A35C] hover:text-[#d88c45] font-semibold">
                Login
              </Link>
            </p>
          </div>
