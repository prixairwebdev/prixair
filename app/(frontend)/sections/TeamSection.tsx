  ...
  return (
    <section className="py-16 bg-white text-center">
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <h4 className="text-sm text-orange-600 tracking-widest font-semibold mb-1">TEAM</h4>
          <h2 className="text-2xl mb-12 text-black maintext">MEET THE TEAM</h2>
        </motion.div>
