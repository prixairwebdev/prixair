        ...
        return (
            <div className="min-h-screen bg-[#fcfbf9] flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-[#1A1A1A]">Loading addresses...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-[#1A1A1A] mb-2">My Addresses</h1>
                ...
                {showAddForm && (
                    <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
                        <h2 className="text-2xl font-bold text-[#1A1A1A] mb-4">Add New Address</h2>
                        <form onSubmit={handleAddAddress} className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full border border-gray-300 rounded-lg px-4 py-2 text-[#1A1A1A] focus:outline-none focus:ring-2"
                                        style={{ '--tw-ring-color': PRIMARY_COLOR } as React.CSSProperties}
                                        required
                                    />
                                </div>
                                <div>
                                    <label className="block text-[#1A1A1A] font-medium mb-2">Phone Number</label>
                                    <input
                                        type="tel"
                            ...
                            <div>
                                <label className="block text-[#1A1A1A] font-medium mb-2">Street Address</label>
                                <input
                                    type="text"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label className="block text-[#1A1A1A] font-medium mb-2">State</label>
                                    <input
                                        type="text"
                                ...
                                <div>
                                    <label className="block text-[#1A1A1A] font-medium mb-2">Zip Code</label>
                                    <input
                                        type="text"
                            ...
                            <div>
                                <label className="block text-[#1A1A1A] font-medium mb-2">Address Type</label>
                                <select
                                    value={formData.type}
                            ...
                            <div className="flex gap-3">
                                ...
                                <button
                                    ...
                                    className="bg-gray-200 text-[#1A1A1A] px-6 py-3 rounded-lg hover:bg-gray-300 transition-colors font-semibold"
                                >
                                    Cancel
                                </button>
                            </div>
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-12 text-center border-2 border-dashed border-gray-200">
                        ...
                        <h2 className="text-2xl font-bold text-[#1A1A1A] mb-2">No Addresses Saved</h2>
