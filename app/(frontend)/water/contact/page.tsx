...
export default function Home() {
  ...
  return (
    <div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24">
            ...
            >
              <motion.h1
                ...
                variants={item}
              >
                Let’s Tailor a Water Solution for You
              </motion.h1>
              ...
              <motion.p
                ...
                variants={item}
              >
                Whether it's bulk supply for your event, business, or
                organization, we’ll provide a custom quote based on your needs.
              </motion.p>
            </motion.div>
          </div>
        </div>
      ...
      {/* contact form  Request Form Section */}
