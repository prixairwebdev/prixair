...
import Minningtwo from "./mining2";
    ...
    <div>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,0,0.3)), url('/wwdbg.png')`,
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24">
            ...
            >
              ...
              <motion.p
                ...
                variants={item}
              >
                At Prixair Resources, we operate across the full spectrum of
                mining — from exploration to processing — with cutting-edge
                technology, environmental stewardship, and a vision for
                sustainable development. Our core operations include:
              </motion.p>
            </motion.div>
          </div>
        </div>
