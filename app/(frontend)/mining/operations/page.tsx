...
import Minning from "../whatwedo/Mining";
import Minningtwo from "../whatwedo/mining2";
    ...
    <div>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,0,0.3)), url('/images/exploration-bg.png')`,
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24">
            ...
            >
              ...
              <motion.p
                ...
                variants={item}
              >
                From Niger to Plateau, powering Nigeria's mineral future through
                precision mining and sustainable growth.
              </motion.p>
            </motion.div>
          </div>
        </div>
