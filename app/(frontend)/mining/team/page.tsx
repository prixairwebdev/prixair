          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24">
            ...
            >
              ...
              <motion.p
                ...
                variants={item}
              >
                At Prixair Resources, our strength lies in our people — a
                multidisciplinary team of leaders, engineers, and strategists
                powering the future of sustainable mining in Nigeria.
              </motion.p>
            </motion.div>
          </div>
        </div>
