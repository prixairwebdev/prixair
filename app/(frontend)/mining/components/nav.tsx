...
const navItems = [
  ...
  { name: "About Us", href: "/mining/about" },
  { name: "Operations", href: "/mining/operations" },
  { name: "Team", href: "/mining/team" },
  { name: "News", href: "/mining/news" },
  { name: "Careers", href: "/mining/careers" },
...
function Nav() {
  ...
  const isActive = (href: string) =>
    href === "/mining" ? pathname === "/mining" : pathname.startsWith(href);
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between px-6 md:px-14">
          {/* Logo */}
          <Link href="/mining" className="relative z-10 flex-shrink-0">
            <Image
              src="/logomining.png"
              alt="Prixair Resources"
              width={150}
              height={75}
          ...
          <Link
            href="/mining/contact"
            className={`hidden lg:inline-block px-5 py-2 text-sm font-semibold transition-all duration-300 ${
              isScrolled
        ...
        {menuOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-9 right-0 h-[calc(100%-2.25rem)] w-[75vw] max-w-xs bg-white z-[59] lg:hidden flex flex-col shadow-2xl"
            >
              {/* Panel header */}
                  ...
                  return (
                    ...
                    >
                      <Link
                        href={item.href}
                        onClick={() => setMenuOpen(false)}
                        className={`flex items-center justify-between py-3 text-base font-medium border-b border-gray-50 transition-colors ${
                          active ? "text-black" : "text-gray-500 hover:text-black"
                        }`}
                      >
                        {item.name}
