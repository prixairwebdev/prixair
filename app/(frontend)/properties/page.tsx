  ...
  return (
    <>
      ...
      <section className="relative h-screen min-h-[600px] w-full flex items-center">
        <Image src="/homesbg.png" alt="Prixair Properties" fill priority sizes="100vw" className="object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-14 w-full pt-32">
          ...
          >
            Elevate Your Space with<br />Premium Finishing
          </motion.h1>
          <motion.p
          ...
          >
            Top-quality tiles, doors, fittings, and interior materials — designed to last and impress.
          </motion.p>
          <motion.div
