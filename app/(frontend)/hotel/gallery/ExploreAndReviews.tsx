    ...
    <section className="px-6 md:px-16 lg:px-24 py-20 space-y-24 bg-white text-gray-800">
      ...
      <div className="text-center">
        ...
        <p className="text-gray-600 mb-10">
          From cozy rooms to relaxing lounges, take a visual tour of everything
          waiting for you at Prixair Hotels.
        </p>
      ...
      <section className="bg-gray-900 text-white text-center py-20 px-6">
        ...
        <p className="text-gray-300 mb-8 max-w-xl mx-auto">
          Whether you're here for business, pleasure, or relaxation, our curated
          amenities ensure your stay is seamless, stylish, and satisfying.
        </p>
