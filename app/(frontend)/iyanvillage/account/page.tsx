...
// Iyan Village Colors
const PRIMARY_COLOR = "#FE0000";
const SECONDARY_COLOR = "#F3A35C";
const STORE_SLUG = "iyanvillage";
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <Link href={`/${STORE_SLUG}/account/orders`} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow group">
                        <div className="w-12 h-12 bg-opacity-10 rounded-full flex items-center justify-center mb-4 group-hover:scale-110 transition-transform" style={{ backgroundColor: `${SECONDARY_COLOR}1A`, color: SECONDARY_COLOR }}>
                            📦
                        </div>
