          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24">
            ...
            >
              <motion.h1
                ...
                variants={item}
              >
Purity in Every Drop. Trust in Every Bottle.              </motion.h1>

              <motion.p
                className="mt-4 sm:mt-6 text-sm sm:text-base md:text-lg text-gray-400/90 leading-relaxed max-w-3xl mx-auto sm:mx-0"
                variants={item}
              >
We deliver more than just hydration — we deliver health, safety, and clarity with every bottle.              </motion.p>
