...
export default function LaundryLocator() {
  ...
  const handleSubmit = () => {
    ...
    const query = `YourLaundry Service, ${selectedLga}, ${selectedState}, Nigeria`;
  ...
  return (
    <section className="py-12 px-4 bg-white text-center">
      <h2 className="text-xl sm:text-2xl font-semibold mb-2">
        Find Our Laundry Locations Across Nigeria
      </h2>
      <p className="text-sm sm:text-lg sm:w-[50%] mx-auto text-gray-500 mb-4">
        Locate your nearest laundry service easily. We&rsquo;re here to serve you for all your laundry needs—nationwide.
      </p>
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center gap-2 sm:gap-4 max-w-2xl mx-auto bg-white shadow-md p-4 rounded-md">
        ...
        <button
          ...
          className="w-full sm:w-auto bg-blue-400 hover:bg-blue-500 text-white p-3 rounded-md flex justify-center items-center"
        >
          <Search size={20} />
        </button>
      </div>
