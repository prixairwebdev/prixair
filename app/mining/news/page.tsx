    ...
    <div>
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(to right, rgba(0,0,0,0.7), rgba(0,0,0,0.3)), url('/newsbg.png')`,
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-24">
            ...
            >
              ...
              <motion.p
                ...
                variants={item}
              >
                Stay ahead with the latest updates, exploration breakthroughs,
                and strategic moves from Prixair Resources.
              </motion.p>
            </motion.div>
          </div>
        </div>
